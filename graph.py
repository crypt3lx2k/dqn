...
def build_graph (actions, optimizer=None, stacked_shape=None, learning_rate=None):
    graph = tf.Graph()
    ...
    with graph.as_default():
        ...
        with tf.variable_scope('action_value'):
            action_value = build_action_value(image, a, t, actions_n)

        with tf.variable_scope('target_value'):
            target_value = build_action_value(image, a, t, actions_n)
